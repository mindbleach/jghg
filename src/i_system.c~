...
// Horrible hack, but less horrible than usual - this file barely uses SDL. 
// There's like two SDL_Quit calls, and one popup if you aren't running from a terminal. 
