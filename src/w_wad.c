...
// Can't be in multiple .c files simultaneously. 
//#include "i_miniwad.h"
...
//#define JGHG_FAKEWAD 		// Here for now. 

#ifdef JGHG_FAKEWAD
	// Gave this a whack, and finally got it to compile, but it doesn't really start. 
	// "W_GetNumForName: PNAMES not found!"
	// Not dealing with that. Skip the fake IWAD thing for now. 

	// Crudely copied from w_file_stdc.c. 
	typedef struct
	{
		wad_file_t wad;
		FILE *fstream;
...
//    result->fstream = fstream;
	...
	// Debug:
	printf( "w_wad.c - W_AddFile filename: %s \n", filename ); 

#ifndef JGHG_FAKEWAD 		// Not an obstacle, just irrelevant. 
	...
	// Think this is where we finally read the goddamn file. 
